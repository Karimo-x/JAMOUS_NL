    ...
    <div className="min-h-screen">
      ...
      <section 
        ...
        style={{ 
          minHeight: '90vh',
          marginTop: '80px',
          backgroundImage: 'url(https://images.pexels.com/photos/7910056/pexels-photo-7910056.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=1080&w=1920)',
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center" style={{ minHeight: '90vh' }}>
          <div className="w-full md:w-2/3 lg:w-1/2 text-center md:text-right animate-fadeIn py-10 md:py-0">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center md:items-start gap-4 mb-10 md:mb-0">
              <Link
                to="/equipment"
