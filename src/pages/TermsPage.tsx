          ...
          <div className="space-y-8 text-gray-700">
            <section>
              ...
              <p className="leading-relaxed">
                باستخدامك لموقع JAMOUS_<span style={{ color: '#FFC107' }}>NL</span> والخدمات المقدمة، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على هذه الشروط، يرجى عدم استخدام الموقع.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                جميع المحتويات على هذا الموقع، بما في ذلك النصوص والصور والشعارات، محمية بحقوق الطبع والنشر وهي ملك لـ JAMOUS_<span style={{ color: '#FFC107' }}>NL</span>. لا يجوز استخدام أو نسخ أي محتوى دون إذن كتابي مسبق.
              </p>
            </section>
